...
#define hargaB 750000
#define hargaC 800000
#define hargaX 950000
#define hargaY 1000000

//untuk SOAL BONUS 
#define pabrikA 400000
#define pabrikB 600000
#define pabrikC 700000
#define pabrikX 800000
#define pabrikY 850000
    ...
    do{
        ...
        if(cekIn==1){
            do{
                system("cls");
                printf("\n\t\t==== MENU ====");
                printf("\n\t  Ketersediaan Jam : \n\t  %d Jam A - %d Jam B - %d Jam C - %d Jam X - %d Jam Y", jmlA, jmlB, jmlC, jmlX, jmlY);
                printf("\n\t[1] Input Pembeli");
                printf("\n\t[2] Input Pembelian");
                printf("\n\t[3] Rincian");
                printf("\n\t[4] Reset Data");
                ...
                switch (pil){
                    ...
                    case 2:
                        if(pembeli==0){
                            ...
                            printf("\n\t\t===== INPUT PEMBELIAN =====");
                            printf("\n\tJenis Jam yang ingin dibeli (A/B/C/X/Y) : "); fflush(stdin); gets(jenis);
                            cekJenis(&tempJenis, jenis, jmlA, jmlB, jmlC, jmlX, jmlY);

                            if(tempJenis==-1){
                                printf("\n\t\t[!] Jenis Jam tidak diketahui!");
                            }else{
                                printf("\n\tJumlah Jam yang ingin dibeli : "); scanf("%d", &jumlah);
                                if(tempJenis==0){
                                    printf("\n\t\t[!] Jam jenis ini sudah habis!");	
...
void rincianPembelian(int jmlA, int jmlB, int jmlC, int jmlX, int jmlY, int hA, int hB, int hC, int hX, int hY, int totA, int totB, int totC, int totX, int totY){
	...
	printf("\n\n\t\t\t===== RINCIAN =====");
	printf("\n\tJam A      | %d |\t| @Rp %d  |\t---> Total : Rp %d", jmlA, hA, totA);
	printf("\n\tJam B      | %d |\t| @Rp %d  |\t---> Total : Rp %d", jmlB, hB, totB);
	printf("\n\tJam C      | %d |\t| @Rp %d |\t---> Total : Rp %d", jmlC, hC, totC);
	printf("\n\tJam X      | %d |\t| @Rp %d |\t---> Total : Rp %d", jmlX, hX, totX);
	printf("\n\tJam Y      | %d |\t| @Rp %d |\t---> Total : Rp %d", jmlY, hY, totY);
}
